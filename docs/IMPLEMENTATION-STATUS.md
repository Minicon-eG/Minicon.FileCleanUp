...
- 61 tests, fresh package installation and process-kill acceptance passed on Windows/Linux/macOS. Windows SMB/restart, lock, ACL and junction acceptance also passed: [verified CI run](https://github.com/Minicon-eG/Minicon.FileCleanUp/actions/runs/34818315469). CodeQL completed successfully on the same code revision.
